...
import {
  Form, Col, Radio, Select, Input, Modal, Upload, Switch,
} from 'antd';
import {
  FormInput, FormDatePicker, FormTimePicker, HalfWidthButton,
...
export const BackButton = ({ isValidating, onClick }) => (
  <HalfWidthButton type="default" htmlType="submit" loading={isValidating} onClick={onClick}>
    Back
  </HalfWidthButton>
);
