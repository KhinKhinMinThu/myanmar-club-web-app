...
export const EventNameInput = ({ decorator }) => (
  <FormItem {...layout} label="Event Name">
    {decorator('eventName')(<text> Blah Blah Event </text>)}
  </FormItem>
);
...
export const EventDescriptionInput = ({ decorator }) => (
  <FormItem {...layout} label="Description">
    {decorator('eventDescription')(<text> This is day event conducted by Ssayar Myat.</text>)}
  </FormItem>
);
...
export const SaveUpdateButton = ({ isValidating, onClick }) => (
...
export const BackButton = ({ isValidating, onClick }) => (
  <HalfWidthButton type="default" htmlType="Back" loading={isValidating} onClick={onClick}>
    Back
  </HalfWidthButton>
);
